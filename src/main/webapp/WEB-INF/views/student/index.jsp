            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="/student/index"><i class="fa fa-circle-o"></i>可选课程</a></li>
                        <li><a href="/student/course/selectedCourse"><i class="fa fa-circle-o"></i>已选课程</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
...
<script type="text/javascript">
    $(function () {
        $("#dataTable").DataTable({
            ...
            "ajax": {
                "url": "/student/course/optional/page"
            },
            // 保存状态
            "stateSave": true,
            // 设置列的数据源
            "columns": [
                ...
                {"data": "score"},
                {
                    "data": function (row, type, val, meta) {
                        return '<a href="/student/course/select?courseId=' + row.courseId + '" type="button" class="btn btn-sm btn-primary"><i class="fa  fa-check"></i> 选课</a>&nbsp;&nbsp;&nbsp;';
                    }
                }
            ],
            // 国际化
