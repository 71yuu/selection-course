...
<script type="text/javascript">
    function deleteCourse(url) {
        var flag = confirm("此操作会删除该课程的所有学生选课信息，请慎用！！！");
        if (flag) {
            ...
            "columns": [
                ...
                {"data": "score"},
                {
                    "data": function (row, type, val, meta) {
                        var deleteUrl = "/admin/course/delete?courseId=" + row.courseId;
                        return '<a href="/admin/course/form?courseId=' + row.courseId + '" type="button" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;&nbsp;' +
                            '<button type="button" class="btn btn-sm btn-danger" onclick="deleteCourse(\''+ deleteUrl + '\')"><i class="fa fa-trash-o"></i> 删除</button >';
                    }
                }
            ],
            // 国际化
