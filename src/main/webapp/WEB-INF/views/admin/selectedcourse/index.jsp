            ...
            "columns": [
                ...
                {"data": "stuCount"},
                {
                    "data": function (row, type, val, meta) {
                        return '<a href="/admin/selectedcourse/detail?courseId=' + row.courseId + '" type="button" class="btn btn-sm btn-primary"><i class="fa fa-search"></i> 查看详情</a>&nbsp;&nbsp;&nbsp;' ;
                    }
                }
            ],
            // 国际化
