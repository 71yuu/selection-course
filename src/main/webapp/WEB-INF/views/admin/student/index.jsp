            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <a href="/admin/student/form" type="button" class="btn btn-sm btn-default" style="display: inline-block"><i class="fa fa-plus"></i> 新增</a>&nbsp;&nbsp;&nbsp;
                        </div>
...
<script type="text/javascript">
    function deleteStudent(url) {
        var flag = confirm("此操作会删除该学生的所有选课信息，请慎用！！！");
        if (flag) {
            ...
            "columns": [
                ...
                {"data": "sex"},
                {
                    "data": function (row, type, val, meta) {
                        return DateTime.format(row.birthYear, "yyyy-MM-dd");
                    }
                },
                {
                    "data": function (row, type, val, meta) {
                        return DateTime.format(row.grade, "yyyy-MM-dd");
                    }
                },
                {"data": "college.collegeName"},
                {
                    "data": function (row, type, val, meta) {
                        var deleteUrl = "/admin/student/delete?userId=" + row.userId;
                        return '<a href="/admin/student/form?studentId=' + row.userId + '" type="button" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;&nbsp;' +
                            '<button type="button" class="btn btn-sm btn-danger" onclick="deleteStudent(\''+ deleteUrl + '\')"><i class="fa fa-trash-o"></i> 删除</button >';
                    }
                }
            ],
            // 国际化
