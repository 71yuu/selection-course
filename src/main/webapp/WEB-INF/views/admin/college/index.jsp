            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <a href="/admin/college/form" type="button" class="btn btn-sm btn-default" style="display: inline-block"><i class="fa fa-plus"></i> 新增</a>&nbsp;&nbsp;&nbsp;
                        </div>
...
<script type="text/javascript">
    function deleteCollege(url) {
        var flag = confirm("您确定删除该院系吗?");
        if (flag) {
            ...
            "columns": [
                ...
                {"data": "collegeName"},
                {
                    "data": function (row, type, val, meta) {
                        var deleteUrl = "/admin/college/delete?collegeId=" + row.collegeId;
                        return '<a href="/admin/college/form?collegeId=' + row.collegeId + '" type="button" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;&nbsp;' +
                            '<button type="button" class="btn btn-sm btn-danger" onclick="deleteCollege(\''+ deleteUrl + '\')"><i class="fa fa-trash-o"></i> 删除</button >';
                    }
                }
            ],
            // 国际化
