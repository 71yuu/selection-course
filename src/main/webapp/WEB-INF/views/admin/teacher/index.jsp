            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <a href="/admin/teacher/form" type="button" class="btn btn-sm btn-default" style="display: inline-block"><i class="fa fa-plus"></i> 新增</a>&nbsp;&nbsp;&nbsp;
                        </div>
    ...
    $(function () {
        $("#dataTable").DataTable({
            ...
            "columns": [
                ...
                {
                    "data": function (row, type, val, meta) {
                        var deleteUrl = "/admin/teacher/delete?userId=" + row.userId;
                        return '<a href="/admin/teacher/form?teacherId=' + row.userId + '" type="button" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;&nbsp;' +
                            '<button type="button" class="btn btn-sm btn-danger" onclick="deleteTeacher(\''+ deleteUrl + '\')"><i class="fa fa-trash-o"></i> 删除</button >';
                    }
                }
            ],
            // 国际化
