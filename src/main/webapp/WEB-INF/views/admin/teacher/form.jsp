        ...
        <section class="sidebar">
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/admin/teacher/list"><i class="fa fa-circle-o"></i>教师列表</a></li>
                        <li class="active"><a href="/admin/teacher/form"><i class="fa fa-circle-o"></i>新增教师</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                ...
                <div class="col-xs-12">
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title">${teacher.userId == null ? "新增" : "编辑"}教师</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <form id="teacherForm" role="form" action="/admin/teacher/save" method="post">
                                <input type="hidden" name="userId" value="${teacher.userId}"/>
                                <!-- text input -->
                                <div class="form-group">
                                    <label>教师名称</label>
                                    <input id="userName" name="userName" type="text" class="form-control required" value="${teacher.userName}" placeholder="请输入教师名称">
                                </div>
                                <div class="form-group">
                                    <label>性别</label> <br/>
                                        <input id="sex" name="sex" type="radio" name="optionsRadios" value="男" ${teacher.sex == null ? "checked" : ""}  ${teacher.sex == '男' ? "checked=''" : ""} >
                                        男
                                        <input id="sex" name="sex" type="radio" name="optionsRadios"  value="女" ${teacher.sex == '女' ? "checked=''" : ""}>
                                        女
                                </div>
                                <div class="form-group">
                                    <label>学历:</label>
                                    <select id="degree" name="degree" class="form-control required" style="width: 100%;">
                                        <option value="本科" ${teacher.degree == '本科' ? "selected" : ""}>本科</option>
                                        <option value="硕士" ${teacher.degree == '硕士' ? "selected" : ""}>硕士</option>
                                        <option value="博士" ${teacher.degree == '博士' ? "selected" : ""}>博士</option>
                                    </select>
                                </div>
                                <!-- Date -->
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input name="birthYear" type="text" class="form-control pull-right datepicker" id="datepicker" value="<fmt:formatDate value='${teacher.birthYear}' pattern='MM/dd/yyyy'/>" >
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                <div class="form-group">
                                    <label>教学职称:</label>
                                    <select id="title" name="title" class="form-control required " style="width: 100%;">
                                        <option value="助教" ${teacher.title == '助教' ? "selected" : ""}>助教</option>
                                        <option value="普通教师" ${teacher.title == '普通教师' ? "selected" : ""}>普通教师</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input id="grade" name="grade" type="text" class="form-control pull-right datepicker" value="<fmt:formatDate value='${teacher.grade}' pattern='MM/dd/yyyy'/>">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                <div class="form-group">
                                    ...
                                    <select id="collegeId" name="collegeId" class="form-control required" style="width: 100%;">
                                        <c:forEach items="${collegeList}" var="college">
                                            <option value="${college.collegeId}" ${college.collegeId == teacher.collegeId ? "selected" : ""}>${college.collegeName}</option>
                                        </c:forEach>
                                    </select>
                                </div>
